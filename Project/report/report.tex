...
\begin{figure}[htb]
	\centering
	\subfloat[Nonobtuse.]{\includegraphics[width=0.3\columnwidth]{figs/regions1.pdf}}
	\quad
	\subfloat[$\protect\angle p_i \ge \theta_{\min}$.]{\includegraphics[width=0.3\columnwidth]{figs/regions2.png}}
	\quad
	\subfloat[Both objectives.]{\includegraphics[width=0.3\columnwidth]{figs/regions3.png}}	
